...
writeText(c2.canvas, c2.context, "UP-KEEPS\n\nKEEP INNOVATING");
...
class Particle {
  constructor(canvas, options) {
    ...
    this.color = this.radius > 5 ? "#fbfbfb" : "#11111"; //this.randomColor()
  }
  ...
  render() {
    ...
    this.canvas.arc(this.x, this.y, this.radius, 0, 1 * Math.PI);
